...
class Tests:
    ...
    def test_linear_reg(self):# Initialize parameters
        ...
        print("---- Linear ----")
        errors, model_names = self.linear_regression_loop(fit_intercepts)
    ...
    def linear_regression_loop(self, fit_intercepts):
        errors, model_names = [], []
        ...
        for fit_intercept in fit_intercepts:
            ...
            nmse,nmse_x,nmse_y,nmse_z = all_NMSE(self.y, y_pred)
